 ...
 * @author Jinkai.Ma
 */
public class DapengClientInterceptor implements AroundInterceptor1 {
    ...
    public void before(Object target, Object arg0) {
        ...
        if (trace.canSampled()) {
            ...
            recorder.recordServiceType(DapengConstants.DUBBO_CONSUMER_SERVICE_TYPE);
            ...
            invocation.setAttachment(DapengConstants.META_DO_NOT_TRACE, "1");
        }
    }
