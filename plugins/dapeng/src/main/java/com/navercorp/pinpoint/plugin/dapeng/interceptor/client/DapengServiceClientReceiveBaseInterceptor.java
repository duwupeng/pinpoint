 ...
 */
public class DapengServiceClientReceiveBaseInterceptor extends SpanEventSimpleAroundInterceptorForPlugin {

    private final boolean traceServiceResult;
    
    public DapengServiceClientReceiveBaseInterceptor(TraceContext context, MethodDescriptor descriptor, boolean traceServiceResult) {
    ...
    protected void doInBeforeTrace(SpanEventRecorder recorder, Object target, Object[] args) {
        recorder.recordServiceType(DapengConstants.DAPENG_CLIENT_INTERNAL);
    }
    ...
    protected void doInAfterTrace(SpanEventRecorder recorder, Object target, Object[] args, Object result, Throwable throwable) {
        ...
        if (throwable == null && this.traceServiceResult) {
            if (args.length == 2 && (args[0] instanceof TBase)) {
                ...
                recorder.recordAttribute(DapengConstants.DAPENG_RESULT, resultString);
            }
        } else {
